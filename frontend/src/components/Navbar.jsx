  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/90 shadow-sm backdrop-blur-xl">
      <div className="mx-auto flex max-w-[1440px] items-center justify-between px-6 py-3.5">
        ...
        >
          <div className="flex h-14 w-14 items-center justify-center overflow-hidden rounded-2xl bg-white shadow-md shadow-blue-900/10 ring-1 ring-slate-200 transition group-hover:scale-105">
            <img
              src={Logo}
        ...
        <nav className="hidden items-center rounded-full border border-slate-200 bg-slate-50 p-1 shadow-inner lg:flex">
          {navItems.map((item) => {
